...
public:
  ...
  // with angle constrains
  // heading: 艏向角deg, theta: 转向角deg, radius: 半径网格数
  static void afm2(GridMap &gm, double heading, double theta, int radius);
  static void my_afm2(GridMap &gm, double heading, int radius);
};
